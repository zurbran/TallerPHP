...
<head>
    ...
    <script src="js/bootstrap.js"></script>
        ...
        $query = "SELECT l.portada, l.titulo, a.nombre, a.apellido, l.cantidad, l.descripcion, l.id FROM libros l INNER JOIN autores a ON (l.autores_id = a.id) WHERE l.id = ". $book .";";
        ?>
</head>
